...
<select class="form-control" name="published">
    @if(isset($article->id))
        ...
        <option value="1" @if($article->published == 1) selected="" @endif>Опубликовано
        </option>
    @else
...
<label for="">Мета описание</label>
<input type="text" class="form-keyword" name="meta_title" placeholder="Мета описание, через запятую" value="{{$article->form-keyword or""}}">
